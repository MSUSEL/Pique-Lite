...
var _chunkNDGYEI3Acjsjs = require('./chunk-NDGYEI3A.cjs.js');
...
var internalJotaiStore = _vanilla.createStore.call(void 0, );
...
var useUserStore = () => {
  ...
  const userStore2 = _chunkNDGYEI3Acjsjs.useDevToolsStore.call(void 0, 
...
function useInternalAtomValue(atom8) {
  ...
  _react.useEffect.call(void 0, () => {
    if (!_chunkNDGYEI3Acjsjs.isDevToolsStore.call(void 0, userStore2)) return;
    const atomSubCb = () => {
...
var useAtomsSnapshots = () => {
  ...
  const currentSnapshots = _chunkNDGYEI3Acjsjs.useAtomsSnapshot.call(void 0, opts);
...
var useIsTimeTravelingValue = () => _react2.useAtomValue.call(void 0, isTimeTravelingAtom, useDevtoolsJotaiStoreOptions());
...
var useTimeTravelNavigateActions = () => {
  ...
  const gotoAtomsSnapshot = _chunkNDGYEI3Acjsjs.useGotoAtomsSnapshot.call(void 0, useUserStoreOptions());
...
var SnapshotActions = (props) => {
  ...
  const gotoSnapshot = _chunkNDGYEI3Acjsjs.useGotoAtomsSnapshot.call(void 0, useUserStoreOptions());
...
var isPromiseWithMeta = (x) => x instanceof Promise;
            ...
            if (!atom8.debugPrivate) {
              if (isPromiseWithMeta(atomState.v)) {
                if (atomState.v.status === "pending") {
                  displayValues[atomToPrintable(atom8)] = {
                    status: "pending"
                  };
