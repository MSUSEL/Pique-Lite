...
PIQUE allows you to upload and manage files for different versions of your project. You can compare multiple projects, hide files you don’t need, and filter or search for specific files. 
...
<img src="../../../assets/images/add-project.png" class="medium-img" alt="Add project screen">

2. Click the **Add Files** button

<img src="../../../assets/images/project1-added.png" class="medium-img" alt="JSON files added to Project 1">
...
<img src="../../../assets/images/two-projects-added.png" class="medium-img" alt="Two projects added to PIQUE">
...
If you get an error during upload, refer to the [Input Errors](../input-schema/input-errors.md) page for troubleshooting steps. 